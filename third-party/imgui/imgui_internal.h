...
struct IMGUI_API ImGuiWindow
{
    ...
    float                   WindowRounding;                     // Window rounding at the time of Begin(). May be clamped lower to avoid graphics artifacts with title bar, menu bar etc.
...
namespace ImGui
{
    ...
    IMGUI_API ImDrawList*   GetBackgroundDrawList(ImGuiViewport* viewport);                     // get background draw list for the given viewport. this draw list will be the first graphics one. Useful to quickly draw shapes/text behind dear imgui contents.
