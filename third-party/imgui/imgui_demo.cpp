...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct Dear ImGui to render a mouse cursor itself. Note that a mouse cursor rendered via your application GPU graphics path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
            ...
            ImGui::Text("Also see Style->Rendering for graphics options.");
...
static void ShowDemoWindowMenuBar(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Custom graphics", NULL, &demo_data->ShowAppCustomRendering);
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // will be passed to the graphics backend via the ImDrawCmd structure.
        // If you use one of the default imgui_impl_XXXX.cpp graphics backend, they all have comments at the top
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Text Clipping"))
    {
        ...
        HelpMarker(
            ...
            "Will alter ImGui hit-testing logic + ImDrawList graphics.\n"
            "(use this if you want your clipping rectangle to affect interactions)\n\n"
            "(Center) Using ImDrawList::PushClipRect():\n"
            "Will alter ImDrawList graphics only.\n"
            "(use this as a shortcut if you are only using ImDrawList calls)\n\n"
            "(Right) Using ImDrawList::AddText() with a fine ClipRect:\n"
            "Will alter only this specific ImDrawList::AddText() graphics.\n"
        ...
        for (int n = 0; n < 3; n++)
        {
            ...
            ImGui::PopID();
            if (!ImGui::IsItemVisible()) // Skip graphics as ImDrawList elements are not clipped.
                continue;
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Mouse Cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "If software cursor graphics (io.MouseDrawCursor) is set ImGui will draw the right cursor for you, "
...
// Demonstrate/test graphics huge amount of text, and the incidence of clipping.
static void ShowExampleAppLongText(bool* p_open)
{
    ImGui::SetNextWindowSize(ImVec2(520, 600), ImGuiCond_FirstUseEver);
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    if (!ImGui::Begin("Example: Custom graphics", p_open))
    {
        ImGui::End();
        return;
    }
    ...
    // Tip: If you do a lot of custom graphics, you probably want to use your own geometrical types and benefit of
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        // Demonstrate out-of-order graphics via channels splitting
            ...
            while (clipper.Step())
            {
                for (int line_idx = clipper.DisplayStart; line_idx < clipper.DisplayEnd; line_idx++)
                {
                    ...
                    for (int item_idx = item_min_idx_for_current_line; item_idx < item_max_idx_for_current_line; ++item_idx)
                    {
                        ...
                        // Because we use ImGuiMultiSelectFlags_BoxSelect2d, clipping vertical may occasionally be larger, so we coarse-clip our graphics as well.
                        if (item_is_visible)
                        {
